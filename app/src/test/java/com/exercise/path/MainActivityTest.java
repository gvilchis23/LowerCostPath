...
import com.exercise.exercise.path.BuildConfig;
...
public class MainActivityTest {
    ...
    public void setup() {
        ...
        gridEditText = (EditText) mainActivity.findViewById(com.exercise.exercise.path.R.id.gridEditText);
        resultEditText = (EditText) mainActivity.findViewById(com.exercise.exercise.path.R.id.resultEditText);
        button = (Button) mainActivity.findViewById(com.exercise.exercise.path.R.id.button);
